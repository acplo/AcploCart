...
class AcploCart extends AbstractPlugin implements EventManagerAwareInterface
{
     ...
     *
     * @example $this->AcploCart()->insert($request->getPost());
     * @example $this->AcploCart()->insert(array(id => '', 'qty' => '', 'price' => '', 'name' => ''));
     * @param array $items
     * @access public
     * @return null
     */
     ...
     *
     * @example $this->AcploCart()->update(array('token' => '', 'qty' => ''));
     * @param array $items
     * @access public
     * @return null
     */
     ...
     *
     * @example $this->AcploCart()->remove(array('token' => ''));
     * @param array $items
     * @access public
     * @return null
     */
